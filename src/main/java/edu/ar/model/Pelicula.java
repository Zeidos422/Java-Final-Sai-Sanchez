...
public class Pelicula {
    ...
    public Pelicula(int id, String nombre, String descripcion, String genero, int calificacion, int anio,
            short estrellas, String director) {
        this.id = id;
        this.nombre = nombre;
    ...
    public Pelicula(String nombre, String descripcion, String genero, int calificacion, int anio,
            short estrellas, String director) {
        this.nombre = nombre;
        this.descripcion = descripcion;
        this.genero = genero;
